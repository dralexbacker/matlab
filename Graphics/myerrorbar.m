...
%myERRORBAR Error bar plot: Like errorbar but done so that two error bars are closer together to left of the plot,
% so that it can be cut and occupy less horizontal space
