function lmi = localmax(vector)
% Yields indices where vector has zero derivative and negative 2nd derivative
% AB
%
% See LOCALMIN, PEAKFIND, LOCALMAXWINTERPOL, WRAPLOCALMAX
% Does not interpolate between subindices; in case of shared local maximum returns the first index of it
% Does not detect maxima at the first or last elements of VECTOR
