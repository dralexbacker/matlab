function trimmed = cutcell2dpol(celda,celda2,x,y,celda3)
% function trimmed = cutcell2dpol(celda,minval,maxval,celda2,minval3,maxval3,celda3)
% CUTCELL2DPOL  - 
% Eliminates only values of ea. CELDA element for which the corresponding CELDA2 & CELDA3 elements' values are 
...
% AB Jul 2000
%
% See also CUTCELL, CROPCELL, CROPCELL2D, CUTCELL2DLIN, CROPCELL2DPOL
