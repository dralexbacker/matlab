function trimmed = cropcell2dlin(celda,celda2,x,y,celda3)
% function trimmed = cropcell2dlin(celda,minval,maxval,celda2,minval3,maxval3,celda3)
% CROPCELL2DLIN  - 
% Keeps only values of CELDA for which the corresponding CELDA2 & CELDA3 elements are 
