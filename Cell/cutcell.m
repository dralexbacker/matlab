function trimmed = cutcell(celda,minval,maxval,celda2)
% function trimmed = cutcell(celda,minval,maxval,celda2)
% CUTCELL   - Opposite of CROPCELL
% Removes only values of CELDA for which the corresponding CELDA2 element is 
% contained in [MINVAL:MAXVAL] (default (-Inf:Inf))
