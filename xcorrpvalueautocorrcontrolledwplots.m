...
% [pvaluepermuting1,pvaluepermuting2]=xcorrpvalueautocorrcontrolled(series1,series2,maxi,numtests,PLOT)
% xcorrpvalueautocorrcontrolledwplots Yields p value of the max absolute value of a cross correlation
